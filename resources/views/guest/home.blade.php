    ...
    <div id="app">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary px-0 py-3">
            <div class="container-xl max-w-screen-xl">
                ...
                <!-- Collapse -->
                <div class="collapse navbar-collapse navbar__collapse__menu guest__menu" id="_navbar_collapse">
                    <!-- Nav -->
                    ...
                    @guest
                        ...
                        <div class="d-flex align-items-lg-center mt-3 mt-lg-0 mb-3">
                            <a href="{{ route('register') }}" class="btn btn-sm btn-light w-full w-lg-auto">
                                Cadastre-se
                            </a>
                        </div>
                    @endguest
                    @auth
                        ...
                        <div class="d-flex align-items-lg-center mt-3 mt-lg-0">
                            <a href="{{ route('admin.dashboard') }}" class="btn btn-sm btn-light w-full w-lg-auto navbar__collapse__button">
                        ...
                        <div class="navbar-nav ms-lg-4">
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="btn bg-transparent nav-item nav-link">Sair</button>
                            </form>
        ...
        <div class="pt-18 pb-18  bg-primary">
            <div class="container-xl max-w-screen-xl">
                        ...
                        <div class="text-center">
                            <h1 class="ls-tight font-bolder display-3 text-white  mb-10">
                                <div class="avatar rounded-circle w-24">
                                    <img alt="..." src="https://scontent.ffln13-1.fna.fbcdn.net/v/t39.30808-1/290576104_2314412875366034_4859708018463183135_n.jpg?stp=dst-jpg_s200x200&_nc_cat=106&ccb=1-7&_nc_sid=7206a8&_nc_ohc=mmVI2Q7KqR4AX-fRmau&_nc_ht=scontent.ffln13-1.fna&oh=00_AT8FqUiFiPCRbodGIanwnVdk9RlwhLFnVJBlsP4Y8X5DfQ&oe=62FDEC90">
                                </div>
                            </h1>
                ...
                <div class="row mb-5">
                    <div class="col-12">
                        ...
                        <div class="row card-group">
                            ...
                            <x-article-card />
                            <x-article-card />
                            <a href="#" class="text-primary text-right shadow-none" >
                                Ver mais artigos &nbsp;
            ...
            <div class="row align-items-center justify-content-md-between pb-7">
                <div class="col-md-6">
                    <div class="copyright text-sm text-center text-md-start text-light">
                        &copy; 2022 - Presente <a href="#" class="h6 text-light text-sm font-bold">Eduardo Steffens</a>. Todos os direitos reservados.
                    </div>
                </div>
                <div class="col-md-6">
